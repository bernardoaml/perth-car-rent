      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 bg-brand-navy/5 p-6 md:p-10 rounded-xl shadow-md">
          <h3 className="text-2xl font-bold text-brand-orange mb-4">
            A smarter way to rent a car in Australia
          </h3>
          <p className="text-lg mb-4">
            A car in Australia should be stress-free and low-cost. That’s why we’ve created a smarter way 
            to rent — made for your day-to-day life.
          </p>
          <ul className="list-disc list-inside space-y-1 text-base pl-2">
            <li>On a working holiday visa</li>
            <li>A student needing daily mobility</li>
            <li>A rideshare driver (Uber, DiDi, etc.)</li>
            <li>Or a tourist exploring Australia</li>
          </ul>
          <p className="mt-4 font-semibold">
            From just <span className="text-brand-orange">$160–$170 per week</span>, you're ready to roll.
          </p>
        </div>
        {/* Where We Are */}
...
<div className="mt-12 bg-white border border-brand-orange rounded-xl shadow-md overflow-hidden">
  ...
  <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200">
    ...
    <div className="p-6 space-y-4">
      <h4 className="text-xl font-bold text-brand-navy">✅ Move Technologies</h4>
      <ul className="list-disc list-inside space-y-2 text-brand-navy text-base">
        <li>Average $160–$170 / week</li>
        <li>$300–$400 refundable bond</li>
    ...
    <div className="p-6 space-y-4 bg-brand-navy/5">
      <h4 className="text-xl font-bold text-brand-navy">❌ Traditional Rentals</h4>
      <ul className="list-disc list-inside space-y-2 text-brand-navy text-base">
        <li>Average $300–$400 / week</li>
        <li>$700–$1000 refundable bond</li>
